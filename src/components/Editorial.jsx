...
function Editorial() {
  return (
    <section className="pt-20 font-montserrat px-4 max-w-6xl mx-auto text-slate-800 dark:text-slate-200">
      <h1 className="text-4xl md:text-5xl font-extrabold mb-8 text-slate-900 dark:text-slate-100">Editorial</h1>
      ...
      <div className="float-right ml-6 mb-4 text-center">
        ...
        />
        <p className="mt-2 text-sm font-semibold text-slate-700 dark:text-slate-300 leading-tight">
          Hna. Omaira del C. Sánchez Ardila<br/>Rectora
        </p>
      </div>

      <p className="font-semibold text-justify text-slate-700 dark:text-slate-300">
